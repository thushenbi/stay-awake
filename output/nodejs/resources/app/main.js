...
// 简单日志与错误捕获，便于调试为何窗口未出现
console.log('Stay Awake main.js starting', { argv: process.argv, cwd: process.cwd() });
...
function createWindow() {
    ...
    mainWindow.webContents.on('did-finish-load', () => {
        console.log('Renderer finished loading index.html');
    });
    // 打开 DevTools 以便在打包前调试界面问题
